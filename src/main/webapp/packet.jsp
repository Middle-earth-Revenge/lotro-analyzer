...
try {
	...
	Packet packet = em.find(Packet.class, Integer.valueOf(request.getParameter("packet")));

	// Load either the given analysis or the first one
	Analysis analysis = new Analysis();
	if (request.getParameter("analysis") != null) {
		analysis = em.find(Analysis.class, Integer.valueOf(request.getParameter("analysis")));
	...
	List<PacketGroup> groups = em.createQuery("select group from PacketGroup group order by name", PacketGroup.class).getResultList();
