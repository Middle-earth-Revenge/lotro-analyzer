...
%>
			...
			function getAnalysisEntryDialogContent(key, name, start, end, description, color, foregroundcolor) {
				...
				retval = '<table>' +
					...
					'<tr><th>Start / End</th><td><input type="text" disabled="disabled" id="entry_start" value="0x' + start + '" style="width: 67px;" /><input type="text" disabled="disabled" id="entry_end" value="0x' + end + '" style="margin-left: 10px; width: 67px;" /> (' + (parseInt(end, 16) - parseInt(start, 16)) + ' Bytes)</td><td class="description">First and last byte of datapart in packet</td></tr>' +
